      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md">
              <h3 class="m-b-none">学生管理系统1.0</h3>
              <small>欢迎工号为<asp:Label ID="Label1" runat="server"  style="color: #FF0066; font-size: x-large" Text="Label"></asp:Label>的<asp:Label ID="Label2" style="color: #FF0066; font-size: x-large" runat="server" Text="11111"></asp:Label>教师的到来，在这里您可以查看自己学生信息，录入学生成绩等相关操作。</small> </div>
          </section>
        </section>
