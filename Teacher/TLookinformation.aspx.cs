...
public partial class Teacher_TLookinformation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       {
           var aa=bb.First();
         Label1.Text = aa.TNum; Label2.Text = aa.TName; Label3.Text = aa.TSex;
        Label4.Text = aa.birthday; Label5.Text = aa.nationType; Label6.Text = aa.Province + aa.City + aa.Area;
        Label7.Text = aa.PoliticalStatus; Label8.Text = aa.IdentityID; Label9.Text = aa.workYear;
