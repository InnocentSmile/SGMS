<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcourseDeletE.aspx.cs" Inherits="AcourseDeletE" %>
      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md">
              <h3 class="m-b-none">课程的修改与删除</h3>
             <form runat="server">
                 <span class="auto-style1">查询条件：课程编号</span><asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                 <asp:Button ID="Button4" runat="server" Text="查询" OnClick="Button2_Click" />
                 <span class="auto-style1">课程名称</span><asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                 ...
                 <asp:Button ID="Button1" runat="server" Text="添加课程" OnClick="Button1_Click" />

                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="id" DataSourceID="LinqDataSource5" EnableModelValidation="True" Width="876px">
                     <Columns>
                         <asp:BoundField DataField="id" HeaderText="id" InsertVisible="False" ReadOnly="True" SortExpression="id" />
                         <asp:TemplateField HeaderText="课程编号" SortExpression="CourseID">
                             <EditItemTemplate>
                                 <asp:TextBox ID="TextBox1" runat="server" ReadOnly="True" Text='<%# Bind("CourseID") %>'></asp:TextBox>
                             </EditItemTemplate>
                             <ItemTemplate>
                         ...
                         <asp:BoundField DataField="TeacherName" HeaderText="授课老师" SortExpression="TeacherName" />
                 ...
                 <asp:LinqDataSource ID="LinqDataSource5" runat="server" ContextTypeName="DataClassesDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" TableName="Course" 
                     >
                     <WhereParameters>
                         <asp:ControlParameter ControlID="TextBox3" Name="CourseID" PropertyName="Text" Type="String" />
                         <asp:ControlParameter ControlID="TextBox4" Name="CourseName" PropertyName="Text" Type="String" />
                     </WhereParameters>
                 </asp:LinqDataSource>
