<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AstudentDeletE.aspx.cs" Inherits="AstudentDeletE" %>
      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md">
              <h3 class="m-b-none">学生帐号的修改与删除</h3>
             <form runat="server" style="font-size: large">
                 ...
                 查询条件：学号<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                 ...
                 <asp:Button ID="Button2" runat="server" Text="添加学生帐号" OnClick="Button2_Click1" />
                 <asp:GridView ID="GridView1" Font-Size="Large" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" DataSourceID="LinqDataSource2" EnableModelValidation="True" Width="100%">
                     <Columns>
                         <asp:BoundField DataField="id" HeaderText="id" InsertVisible="False" ReadOnly="True" SortExpression="id" />
                         <asp:BoundField DataField="userType" HeaderText="用户类型" SortExpression="userType" />
                         <asp:TemplateField HeaderText="学号" SortExpression="userName">
                             <EditItemTemplate>
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:LinkButton ID="LinkButton1" OnClientClick="return confirm('您确定删除该学生吗?')" runat="server" CausesValidation="False" CommandName="Delete" Text="删除"></asp:LinkButton>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="DataClassesDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" TableName="studentLogin" 
                     >
                     <WhereParameters>
                ...
                <!-- <br />
                 <asp:GridView ID="GridView2" runat="server" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None">
