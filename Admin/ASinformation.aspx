<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ASinformation.aspx.cs" Inherits="ASinformation" %>
      ...
      <section id="content">
        <section class="vbox">
          ...
          <div class="mm">
                  ...
                  <br />
                  详细地址：<asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox7" ErrorMessage="详细地址不能为空"></asp:RequiredFieldValidator>
                  <br />
                  ...
                  <br />
                  所在院系：<asp:DropDownList ID="DropDownList3" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="LinqDataSource9" DataTextField="DepartmentName" DataValueField="DepartmentName" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged">
                        <asp:ListItem Selected="True">请选择</asp:ListItem>
                    </asp:DropDownList>
                    <asp:LinqDataSource ID="LinqDataSource9" runat="server" ContextTypeName="DataClassesDataContext" Select="new (DepartmentName)" TableName="Department">
                    </asp:LinqDataSource>
                    <br />
                  班级(专业)：<asp:DropDownList ID="DropDownList4" runat="server" >
                        <asp:ListItem Selected="True">未选择</asp:ListItem>
                    </asp:DropDownList>
                  ...
                  <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                      <ContentTemplate>
                  <div class="yy">
                  入学年份：<asp:TextBox ID="TextBox9" runat="server"></asp:TextBox>
                        <div class="mm">
                  ...
                  学制：<asp:DropDownList ID="DropDownList2" runat="server">
                      <asp:ListItem Selected="True">未选择</asp:ListItem>
                      <asp:ListItem>专科三年</asp:ListItem>
                      <asp:ListItem>本科四年</asp:ListItem>
                      <asp:ListItem>本科五年</asp:ListItem>
                  </asp:DropDownList>
                  <br />
