<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ADTinformation.aspx.cs" Inherits="Admin_ADTinformation" %>
      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md">
              <h3 class="m-b-none">教师的修改与删除</h3>
             <form runat="server" style="font-size: large">
                 &nbsp;查询条件：工号<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                 ...
                 <asp:Button ID="Button1" runat="server" Text="添加教师信息" OnClick="Button1_Click" />

                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" DataSourceID="LinqDataSource7" EnableModelValidation="True" ForeColor="Black" GridLines="Vertical" Width="100%">
                     <AlternatingRowStyle BackColor="White" />
                     <Columns>
                         <asp:BoundField DataField="id" HeaderText="编号" InsertVisible="False" ReadOnly="True" SortExpression="id" />
                         <asp:BoundField DataField="TNum" HeaderText="工号" SortExpression="TNum" />
                         ...
                         <asp:BoundField DataField="birthday" HeaderText="出生年份" SortExpression="birthday" />
                         ...
                         <asp:BoundField DataField="Area" HeaderText="区(县)" SortExpression="Area" />
                         <asp:BoundField DataField="Address" HeaderText="现住址" SortExpression="Address" />
                         <asp:BoundField DataField="PoliticalStatus" HeaderText="政治面貌" SortExpression="PoliticalStatus" />
                         <asp:BoundField DataField="_class" HeaderText="所教班级" SortExpression="_class" />
                         <asp:BoundField DataField="department" HeaderText="所在院系" SortExpression="department" />
                         <asp:BoundField DataField="EnrollmentYear" HeaderText="入职年份" SortExpression="EnrollmentYear" />
                         <asp:BoundField DataField="workYear" HeaderText="所教课程" SortExpression="workYear" />
                         ...
                         <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="ATinformation.aspx?id={0}" HeaderText="修改" NavigateUrl="~/Admin/ATinformation.aspx" Text="修改" />
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:LinkButton ID="LinkButton1" OnClientClick="return confirm('您确定删除该教师的信息吗?')" runat="server" CausesValidation="False" CommandName="Delete" Text="删除"></asp:LinkButton>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:LinqDataSource ID="LinqDataSource7" runat="server" ContextTypeName="DataClassesDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" TableName="T_information" 
                     >
                     <WhereParameters>
                         <asp:ControlParameter ControlID="TextBox1" Name="TNum" PropertyName="Text" Type="String" />
                         <asp:ControlParameter ControlID="TextBox2" Name="TName" PropertyName="Text" Type="String" />
                     </WhereParameters>
                 </asp:LinqDataSource>
