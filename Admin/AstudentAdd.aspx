<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AstudentAdd.aspx.cs" Inherits="AstudentAdd" %>
      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md" >
              <h3 class="m-b-none" style="text-decoration-color:green">添加学生帐号</h3>
                <p class="m-b-none">&nbsp;</p>
              <center>
                <form runat="server">
                    <span class="auto-style1">学号：</span><asp:TextBox ID="TextBox1" runat="server" Height="25px" Width="132px"></asp:TextBox>
                    <br />
                    <br />
                    <span class="auto-style1">密码：<asp:TextBox ID="TextBox2" runat="server" Height="25px" Width="132px"></asp:TextBox>
                    <br />
                    <br />
                    <span class="auto-style1">名字：<asp:TextBox ID="TextBox3" runat="server" Height="25px" Width="132px"></asp:TextBox>
                    <br />
                    </span><br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
