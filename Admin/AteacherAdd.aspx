<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AteacherAdd.aspx.cs" Inherits="AteacherAdd" %>
      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md" >
              <h3 class="m-b-none" style="text-decoration-color:green">教师帐号添加</h3>
                <p class="m-b-none">&nbsp;</p>
              <center>
                <form runat="server">
                    <span class="auto-style1">工号：</span><asp:TextBox ID="TextBox1" runat="server" Height="25px" Width="132px"></asp:TextBox>
                    <br />
                    <br />
                    <span class="auto-style1">密码：<asp:TextBox ID="TextBox2" runat="server" Height="25px" Width="132px"></asp:TextBox>
                    <br />
                    <br />
                    姓名：<asp:TextBox ID="TextBox3" runat="server" Height="25px" Width="132px"></asp:TextBox>
                    <br />
                    </span><br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="添加" Width="76px" OnClick="Button1_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" Text="查看添加" Width="95px" OnClick="Button2_Click" />
                </form>
                  </center>
            </div>
          </section>
