<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AteacherDeletE.aspx.cs" Inherits="AteacherDeletE" %>
      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md">
              <h3 class="m-b-none">教师帐号的修改与删除</h3>
              <form runat="server">

                  <span class="auto-style1">查询条件：工号</span><asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                 <asp:Button ID="Button2" runat="server" Text="查询" OnClick="Button2_Click" />
                  <span class="auto-style1">姓名</span><asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                 <asp:Button ID="Button3" runat="server" Text="查询" OnClick="Button3_Click" />
                  &nbsp;<asp:Button ID="Button1" runat="server" Text="添加教师" OnClick="Button1_Click" />
                  <asp:GridView ID="GridView1" font-size="Large" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="id" DataSourceID="LinqDataSource3" EnableModelValidation="True" ForeColor="Black" Width="1014px">
                      <Columns>
                          <asp:BoundField DataField="id" HeaderText="id" InsertVisible="False" ReadOnly="True" SortExpression="id" />
                          <asp:BoundField DataField="userType" HeaderText="用户类型" SortExpression="userType" />
                          <asp:TemplateField HeaderText="工号" SortExpression="userName">
                              <EditItemTemplate>
                          ...
                          <asp:TemplateField ShowHeader="False">
                              <ItemTemplate>
                                  <asp:LinkButton ID="LinkButton1" OnClientClick="return confirm('您确定删除该教师吗?')" runat="server" CausesValidation="False" CommandName="Delete" Text="删除"></asp:LinkButton>
                              </ItemTemplate>
                          </asp:TemplateField>
                      </Columns>
                  ...
                  <asp:LinqDataSource ID="LinqDataSource3" runat="server" ContextTypeName="DataClassesDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" TableName="teacherLogin"
                       >
                      <WhereParameters>
                          <asp:ControlParameter ControlID="TextBox3" Name="userName" PropertyName="Text" Type="String" />
                          <asp:ControlParameter ControlID="TextBox2" Name="_Name" PropertyName="Text" Type="String" />
                      </WhereParameters>
                  </asp:LinqDataSource>
